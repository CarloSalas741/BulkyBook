...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "pending":
                    orderHeaders = orderHeaders.Where(u => u.PaymentStatus == SD.PAYMENTSTATUS_DELAYEDPAYMENT);
                    break;
                case "inprocess":
                ...
                case "completed":
                    ...
                    break;
                case "approved":
                    orderHeaders = orderHeaders.Where(u => u.OrderStatus == SD.PAYMENTSTATUS_APPROVED);
                    break;
                default:
                    break;
            }
